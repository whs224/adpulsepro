...
const Header = () => {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-blue-600 to-purple-600 shadow text-white py-4 px-8 flex items-center justify-between">
      <div className="text-2xl font-bold cursor-pointer" onClick={() => navigate("/")}>AdPulse</div>
      <nav className="flex items-center gap-6">
        ...
        {user ? (
          <Button variant="outline" className="text-white border-white hover:bg-white/10" onClick={signOut}>Sign Out</Button>
        ) : (
